...
//                                                ["label" => "Добавление категорий", "url" => ["/add_category"]],
                    ...
                    <div class="sidebar-footer hidden-small">
                        <a id="logout" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="Logout">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    ...
                                    <li><a id="logout_top" href="#"><i class="fa fa-sign-out pull-right"></i> Выйти</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <!-- page content -->
            <div class="right_col" style="height: 2200px" role="main">
