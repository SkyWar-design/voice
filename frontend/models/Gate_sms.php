...
use Yii;
use yii\base\Model;
define("SMSC_LOGIN", "volna");			// логин клиента
define("SMSC_PASSWORD", "ec8262e3bb7077143c65e65b3adb7e98");	// пароль или MD5-хеш пароля в нижнем регистре
...
function call_send($phones, $message, $time = 0, $id = 0, $files = array(), $sender = false)
{

    $result = $this->send_sms($phones, $message, $translit = 0, $time, $id =0 , $format = 9, $sender , $query="", $files);
    return $result;
}
